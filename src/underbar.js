(function() {
  ...
  _.map = function(collection, iterator) {
    ...
    for (let i = 0; i < copyArray.length; i++) {
      tempArray.push(iterator(copyArray[i]));
    }
    return tempArray;
  ...
  _.reduce = function(collection, iterator, accumulator) {
    const tempArray = (Array.isArray(collection)) ? collection.slice() : Object.assign({}, collection);
    if (arguments[2] === undefined) { 
      accumulator = collection[0];
      tempArray.shift();
    }
    _.each(tempArray, function(current) {
  ...
  _.extend = function(obj) {
    let object = Object.assign({}, ...arguments);
    return object;
  };
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (!result[array.join('-')]) {
        result[array.join('-')] = func.apply(this, arguments);
      }
  ...
  _.shuffle = function(array) {
    ...
    for (let i = 0; i < array.length; i++) {
      ...
      output.push(tempArray[randomIndex]);
